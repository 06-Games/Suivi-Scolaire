...
/// </summary>
[CustomEditor(typeof(LayoutSwitcher)), CanEditMultipleObjects]
public class LayoutSwitcherEditor : Editor
{
    SerializedProperty mode;
    SerializedProperty autoSwitch;
    ...
    protected virtual void OnEnable()
    {
        ...
        autoSwitch = serializedObject.FindProperty("autoSwitch");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(autoSwitch, true);
